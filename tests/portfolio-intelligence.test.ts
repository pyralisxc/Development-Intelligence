...
function graph(project: string, revision: string, nodes: GraphNode[]): IntelligenceGraph {
  return {
    ...
    coverage: { trackedFiles: 1, eligibleFiles: 1, analyzedFiles: 1, completeFiles: 1, partialFiles: 0, unsupportedFiles: 0, skippedFiles: 0, failedFiles: 0, skippedOversizedFiles: 0, skippedNonRegularFiles: 0, skippedFileLimitFiles: 0, files: [{ path: 'package.json', status: 'complete', role: 'configuration' }] },
  };
}
